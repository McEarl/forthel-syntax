...
This chapter describes a specification of a parser for lexed TEX documents.
...
<low-level-def choice> = 'choose' [  <article> ] <notion>
                       | "\U+0060;" "\U+0060;" 'choose' [  <article> ] <notion> "\'" "\'"
                       | 'define' <variable> "=" ( <class term> | <class-of term> | <lambda term> )
                       | "\U+0060;" "\U+0060;" 'define' <variable> "=" ( <class term> | <class-of term> | <lambda term> ) "\'" "\'"
```
